...
public class IncomingReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		if (intent.getAction().equals(CUSTOM_INTENT)) {
			...
			{
				publisher = intent.getStringExtra("epl603.assignment2.EXTRA_BOOK_PUBLISHER");
				authors = intent.getStringExtra("epl603.assignment2.EXTRA_BOOK_AUTHORS");
			...
			Log.d("RESUUUUULT", intent.getStringExtra("epl603.assignment2.EXTRA_LOOKUP_RESULT"));			
			/*
